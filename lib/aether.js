(function() {
  var Aether, acorn_loose, defaults, escodegen, esprima, execution, jshint, morph, normalizer, optionsValidator, problems, regenerator, regenerator_runtime, transforms, _, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
    __slice = [].slice;
  ...
  regenerator = (_ref3 = (_ref4 = (_ref5 = typeof window !== "undefined" && window !== null ? window.regenerator : void 0) != null ? _ref5 : typeof self !== "undefined" && self !== null ? self.regenerator : void 0) != null ? _ref4 : typeof global !== "undefined" && global !== null ? global.regenerator : void 0) != null ? _ref3 : require('regenerator');
  ...
  module.exports = Aether = (function() {
    ...
    Aether.prototype.purifyCode = function(rawCode) {
      var error, instrumentedCode, normalized, normalizedAST, normalizedCode, normalizedNodeIndex, normalizedSourceMap, originalNodeRanges, postNormalizationTransforms, preNormalizationTransforms, preprocessedCode, problem, regeneratedCode, transformedAST, transformedCode, wrappedCode, _ref6, _ref7, _ref8;
