(function() {
  ...
  module.exports = Aether = (function() {
    ...
    Aether.hasChangedSignificantly = function(a, b, careAboutLineNumbers) {
      var aAST, bAST, e, options, walk, _ref6, _ref7;
      ...
      if (aAST && bAST) {
        if (((_ref6 = aAST.errors) != null ? _ref6 : []).length !== ((_ref7 = bAST.errors) != null ? _ref7 : []).length) {
          return true;
        }
