...
# Because regenerator expects to read this runtime from a file, I'm duplicating
# it here so we can have easy access to it from our code.

MIN = false

if MIN
  module.exports = regenerator_runtime = """
...
"""
  ...
  module.exports = regenerator_runtime = """
var wrapGenerator = function(innerFn, self) {
  var hasOwn = Object.prototype.hasOwnProperty;

  var wrapGenerator = function wrapGenerator(innerFn, self) {
